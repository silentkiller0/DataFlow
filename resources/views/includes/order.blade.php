...
window.onload = function() {
    ...
    $('button[id^="ShowOrder"]').on('click', function (event) {
            let id = $(this).attr("data-Order-id");
            $('button[id^="Download_file"]').attr("data-Order-id",id);
            $('span[id^="status_id"]').html('');
            console.log('clicked');
            $.ajax({
                url: '/flux/order/show/'+id,
                success: function(Data){
                    ...
                    $('span[id^="ref_order"]').html(Data["ref_order"] ?? '---');
    ...
    $('button[id^="Download_file"]').on('click', function (event) {
        ...
        let id_flux = $(this).attr("data-Order-id");
