<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @endif
                <!-- @if(checkPerm('view_demat_invoice'))
                ...
                @endif -->
                @if(checkPerm('view_partners') || checkPerm('view_societies') || checkPerm('view_main_company'))
                <li class="nav-item" id="view_societies"><a><i class="feather icon-globe"></i><span class="menu-title" data-i18n="Clients">Clients</span></a>
                    <ul class="menu-content">
                        @if(checkPerm('view_main_company'))
                ...
                @if(checkPerm('view_configuration'))
